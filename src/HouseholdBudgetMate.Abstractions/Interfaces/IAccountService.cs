...
public interface IAccountService
{
    ...
    Task<AccountMonthBalanceDto> UpsertMonthBalanceAsync(UpsertAccountMonthBalanceRequest request,
    ...
    Task<AccountMonthBalanceDto> UpdateMonthBalanceAmountAsync(UpdateAccountMonthBalanceAmountRequest request,
        CancellationToken cancellationToken);
